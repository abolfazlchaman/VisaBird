    ...
    >
        ...
        <div className="container mx-auto px-4 flex justify-between items-center flex-wrap">
          ...
          <nav className="mt-4 md:mt-0">
            ...
            <ul className="flex flex-wrap justify-center md:justify-start space-x-4">
              ...
              <li>
                <a href="#jobs" className="text-gray-700 hover:text-indigo-700">
                  Jobs
                </a>
              </li>
              <li>
      ...
      <section className="relative bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{ backgroundImage: "url(/placeholder-illustration.svg)" }}
          ></div>{" "}
          {/* Example placeholder */}
        </div>
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl mb-8 text-blue-100 dark:text-blue-200">
            Helping international professionals connect with forward-thinking
            companies.
          </p>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-12">
            Powerful Features to Find Your Dream Job
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              >
                Precisely filter jobs by visa status, country, company, job
                type, and more to find the perfect match.
              </p>
            </div>
            <div
              className={`p-6 rounded-lg shadow-md transition transform hover:scale-105 ${
            ...
            >
              ...
              >
                Our data is transparent, community-backed, and constantly
                updated for accuracy and reliability.
              </p>
            </div>
            <div
              className={`p-6 rounded-lg shadow-md transition transform hover:scale-105 ${
            ...
            >
              ...
              >
                Navigate effortlessly with a fast, clean, and mobile-friendly
                interface designed for a smooth user experience.
              </p>
            </div>
            <div
              className={`p-6 rounded-lg shadow-md transition transform hover:scale-105 ${
            ...
            >
              ...
              >
                Tailored to meet the unique needs of skilled professionals,
                students, and remote workers seeking opportunities abroad.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              >
                Browse our extensive database of international job listings with
                visa sponsorship.
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                Use our advanced filters to narrow down opportunities by
                country, visa status, industry, and more.
              </p>
            </div>
            <div
              className={`p-6 rounded-lg transition transform hover:scale-105 ${
            ...
            >
              ...
              >
                Easily access direct links to company career pages and apply for
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Visabird offers a transparent and efficient way for companies to
            discover and connect with a global pool of skilled professionals.
            Highlight your commitment to international talent and streamline
            your hiring process. We invite HR teams and recruiters to explore
            integration or partnership opportunities to find the perfect
            candidates.
          </p>
          <a
            href="#contact"
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Contact:{" "}
            <a href="mailto:contact@visabird.ir" className="hover:underline">
              contact@visabird.ir
            </a>{" "}
            |{" "}
            <a href="#" className="hover:underline">
